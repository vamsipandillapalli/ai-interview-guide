...
>
  ...
  >
	...
	<button
	  className="hidden group-hover:flex items-center gap-2 text-xs text-rose-500 font-medium absolute bg-rose-50 px-3 py-1 rounded text-nowrap border border-rose-100 hover:border-rose-1200 cursor-pointer absolute top-0 right-0 "
	  onClick={(e) => {
		e.stopPropagation();
		onDelete();
	  }}
  ...
  <div className="px-3 pb-3">
	<div className="flex items-center gap-3 mt-4">
	  <div className="text-[10px] fonr-medium text-black px-3 py-1 border-[0.5px] border-gray-900 rounded-full">
